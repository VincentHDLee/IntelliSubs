...
*   **3.6. 用户界面 (UI) 模块 (Windows风格)**
    ...
    *   **核心操作：**
        ...
        *   **[待办] 字幕预览与编辑界面 (按DI值排序开发)：**
            *   **[已完成 D1I0 - 待测试] 1. 字幕文本直接编辑**：允许直接修改字幕文本内容。
            *   **[待办] 2. 字幕时间码精确调整 (D2I0)**：精确修改每条字幕的开始和结束时间。
            *   **[待办] 3. 基本字幕操作 (D2I1)**：支持插入、删除、合并、拆分字幕行。
...
*   **阶段三: 高级功能、编辑与扩展**
    ...
    *   **功能：**
        ...
        *   **[待办] 字幕编辑功能实现 (按DI值排序开发)：**
            *   **[已完成 D1I0 - 待测试] 1. 字幕文本直接编辑**
            *   **[待办] 2. 字幕时间码精确调整 (D2I0)**
            *   **[待办] 3. 基本字幕操作 (D2I1)**（插入、删除、合并、拆分）
